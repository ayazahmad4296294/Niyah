/**
 * CompanyVerification.jsx - Public Certification Lookup
 * This page provides a high-trust verification interface for companies.
 * Accessible primarily via QR code scan, it displays "blockchain-backed" 
 * certification metadata to ensure data integrity for end-users.
 */
...
const CompanyVerification = () => {
    // URL Parameter extraction for specific record retrieval
    ...
    /**
     * Primary Data Fetch: Verification Record
     * Retrieves the company profile plus dynamic verification-specific metadata 
     * (Transaction Hashes, Verification IDs, etc.) generated by the backend.
     */
    useEffect(() => {
    ...
    // Loading State UI: Smooth spinner for transitions
    if (loading) {
        return (
    ...
    // Error Guard: Displayed if ID is invalid or record is missing
    if (error || !company) {
        return (
            <div className="min-h-screen bg-gray-50 flex flex-col">
                <Navbar />
    ...
    // Formatting date for professional presentation
        ...
        <div className="bg-gray-50 min-h-screen flex flex-col">
            ...
            <main className="grow py-20 px-4 md:px-10">
                <div className="max-w-3xl mx-auto">
                    {/* Visual Back Link for easy navigation after QR scan */}
                    <button 
                        onClick={() => navigate(-1)}
                    ...
                    {/* Main Verification Card: High-Impact branding for trust */}
                    <div className="bg-white rounded-4xl shadow-2xl overflow-hidden border border-gray-100 flex flex-col">
                        {/* Status Header: Emphasizes the "Certified" status */}
                        ...
                        {/* Attribute Grid: Displays core trust signals (Category, Score, Recency) */}
                        <div className="p-8 md:p-12 space-y-12">
                            ...
                            {/* Section: Technical Integrity
                                Explains the underlying proof mechanism (Verification ID & Mock Blockchain Status)
                            */}
                            <div className="space-y-6">
                                ...
                                <div className="bg-gray-50 rounded-2xl p-6 md:p-8 space-y-6 border border-gray-100">
                                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-200 pb-6">
                                        <div>
                                            {/* Globally unique reference for this specific certification period */}
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="bg-white p-4 rounded-xl border border-gray-200 overflow-hidden">
                                            {/* The Transaction Hash represents an immutable link to the chain (Simulated for this MVP) */}
                            ...
                            {/* Conversion: Loop back to full company profile */}
